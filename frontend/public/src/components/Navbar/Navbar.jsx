...
export default function Navbar() {
    ...
    const bannerData = [
        ...
        { image: 'images/banners/674d8680048cc.webp', link: 'tool-kits.html', alt: 'Tool Kits' },
        { image: 'images/banners/674d86800470d.webp', link: 'home-living.html', alt: 'Home Living' },
        { image: 'images/banners/674d868004272.webp', link: 'baby-kids-toys.html', alt: 'Baby Kids Toys' },
      ];
    ...
    return (
        <div>
            ...
            <section>
                <div className="container-fluid px-0 banner-margin-top">
                    <div className="row">
                        <div className="col-12">
